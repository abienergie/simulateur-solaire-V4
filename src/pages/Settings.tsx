...
import { Settings as SettingsIcon, ArrowLeft, Database, Sliders, Zap, Package, ToggleLeft, Calendar, Percent, RefreshCw, Key, Battery, Save, Ticket, Plus, X, ExternalLink, Info } from 'lucide-react';
