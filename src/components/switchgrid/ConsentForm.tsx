                  ...
                  <div className="space-y-4">
                      ...
                      {!iframeLoadError ? (
                        <iframe
                          ...
                          onLoad={() => {
                            ...
                            // Démarrer automatiquement le polling
                            if (currentAsk.status === 'PENDING_USER_ACTION') {
                              startPolling(currentAsk.id);
                            }
                          }}
                          onError={() => {
                        ...
                        <div className="absolute inset-0 bg-gray-50 flex items-center justify-center">
                          <div className="text-center p-6 max-w-md">
                            ...
                            <p className="text-sm text-gray-600 mb-4">
                              Le formulaire ne peut pas s'afficher dans cette fenêtre. Veuillez l'ouvrir dans un nouvel onglet.
                            </p>
                            <a
                              ...
                              onClick={() => {
                                // Démarrer le polling quand l'utilisateur ouvre le formulaire
                                if (currentAsk.status === 'PENDING_USER_ACTION') {
                                  startPolling(currentAsk.id);
                                }
                              }}
                    ...
                    <div className="flex justify-between items-center">
                      <a
                        ...
                        onClick={() => {
                          // Démarrer le polling quand l'utilisateur ouvre le formulaire
                          if (currentAsk.status === 'PENDING_USER_ACTION' && !isPolling) {
                            startPolling(currentAsk.id);
                          }
                        }}
                      ...
                      <div className="text-sm text-gray-500">
                        {iframeLoading ? 'Chargement du formulaire...' : 'Le formulaire est chargé ci-dessus'}
                      </div>
                    </div>
                  </div>
